    ...
    <header>
      <Menu>
        <div className="imageContainer">
          <ImageChoice src={NorteSulLogo} srcSetDesktop={NorteSulLogoDesktop} srcSetMobile={NorteSulLogo} />
          <ImageChoice src={PortoSeguroLogo} srcSetDesktop={PortoSeguroLogoDesktop} srcSetMobile={PortoSeguroLogo} />
